...
function libInHarnessTree(root: string, harness: string, rulesSubdir?: string): string {
  ...
  for (const sibling of ["aidlc-lib.ts", "aidlc-settings.ts", "aidlc-artifact-vocabulary.ts", "aidlc-graph.ts", "aidlc-runtime-paths.ts", "aidlc-stage-schema.ts", "aidlc-version.ts"]) {
